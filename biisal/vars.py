...
class Var(object):
    ...
    NEW_USER_LOG = int(getenv('NEW_USER_LOG', '-1001850979293'))
    PORT = int(getenv('PORT', '8000'))
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
    PING_INTERVAL = int(environ.get("PING_INTERVAL", "1200"))  # 20 minutes
    OWNER_ID = [int(x) for x in os.environ.get("OWNER_ID", "5211097531").split()]
    ...
    if HAS_SSL:
        URL = "https://gorgeous-anitra-avaranan-c6de3c26.koyeb.app/".format(FQDN)
    else:
        URL = "https://gorgeous-anitra-avaranan-c6de3c26.koyeb.app/".format(FQDN)
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'Update2k')) 
    UPDATES_GROUP = str(getenv('UPDATES_GROUP', 'https://t.me/Update2k')) 
